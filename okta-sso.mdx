...
This document describes how to add SSO to Xeol using Okta as the identity provider. 

First, we setup a new app in Okta then share the Okta app connection details with the Xeol team.
